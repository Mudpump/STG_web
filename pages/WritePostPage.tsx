                ...
                {counselingStep === 'SELECT_TYPE' ? (
                    <div className="space-y-4">
                        ...
                        <button 
                            ...
                            className={`w-full text-left p-5 rounded-2xl border transition-all group relative overflow-hidden flex items-start gap-4 ${
                                isRoadmapAvailable 
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <span className={`text-xs font-bold px-2 py-1 rounded border ${
                                counselingType === 'ROADMAP' ? 'text-indigo-600 bg-indigo-50 border-indigo-200' :
                        ...
                        {counselingType === 'ROADMAP' && (
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-gray-600 mb-1">진로 및 포부</label>
                                    <textarea 
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        ...
                                        placeholder="예: 난 컴퓨터로 시뮬레이션 하는거 좋아해, 수학을 잘해 등등" 
